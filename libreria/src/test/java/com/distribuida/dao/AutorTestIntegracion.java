...
public class AutorTestIntegracion {
    ...
    public void testAutorUpdate() {
        Optional<Autor> autor = autorDAO.findById(56);
    ...
    @Test
    public void delete(){
        if (autorDAO.existsById(56)){
            autorDAO.deleteById(56);
        }
        assertFalse(autorDAO.existsById(56),"El autor fue eliminado correctamente");
    }
}
